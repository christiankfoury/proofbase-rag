...
def _write_verification(path: Path, result: dict[str, Any]) -> None:
    ...
    lines.extend(
        [
            ...
            "- The permission evaluator now supports the `vector_lexical_rerank` candidate command with top-k `3` and rerank candidate limit `20`, but that live permission run was not executed.",
