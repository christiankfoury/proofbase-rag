...
export const productionReadinessCatalog: DefenseCatalogItem[] = [
  {
    ...
    phase: "Phase 56",
    status: "planned",
    summary: "Add a provider-neutral OIDC boundary, signed-token verification, and an explicit tenant/data-ownership model.",
    ...
    evidence: [],
    limitations: ["Tenant ownership, membership, session behavior, offboarding, and seeded-data migration require a user decision; live identity integration remains optional."],
