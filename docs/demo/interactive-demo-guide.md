...
| Trust & Safety | `/trust` | Layered defense flow, code-owned control status, Phase 56-58 local identity/tenant/database-policy/abuse-control evidence, hosted-integration limitations, and the Phase 59-63 readiness checklist. |
