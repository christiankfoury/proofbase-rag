...
- Created a 65-question benchmark source corpus with 60-question primary evaluation runs plus separate permission and memory suites measuring retrieval, answer accuracy, citation accuracy, permission leakage, memory, and multi-document reasoning.
